...
void Vector::setx(const double a) // to set the value of xcomp
{
 this->xcomp=a;
}


void Vector::sety(const double a) // to set the value of ycomp
{
 this->ycomp=a;
}

void Vector::setz(const double a) // to set the value of zcomp
{
 this->zcomp=a;
}
